...
function AccountPop() {
  ...
  return <>
      <div className={theme ? "account-pop" : "account-pop account-pop-light light-mode"} style={isBtnClicked === false ? {
      display: "block"
    } : {
      display: "none"
    }}>
        ...
        <div className="about-channel-section">
          <div className={theme ? "yourchannel c-sec" : "yourchannel c-sec2"} onClick={() => {
          if (isChannel === true) {
          ...
          <div className={theme ? "yourstudio c-sec" : "yourstudio c-sec2"} onClick={() => {
          navigate("/studio");
        }}>
            <SiYoutubestudio fontSize="21px" style={{
            color: theme ? "white" : "black"
          }} />
            <p>YouTube Studio</p>
          </div>
          <div className={theme ? "apperance c-sec" : "apperance c-sec2"} onClick={() => {
        ...
        <div className="extra1-section">
          ...
          <div className={theme ? "exitout c-sec" : "exitout c-sec2"} onClick={handleLogout}>
      ...
      <div className={theme ? "account-pop" : "account-pop account-pop-light light-mode"} style={isBtnClicked === true ? {
      display: "block",
      paddingTop: "12px"
    } : {
      display: "none",
      paddingTop: "20px"
        ...
        <div className="appearance-title">
          <ArrowBackOutlinedIcon className={theme ? "back-arrow" : "back-arroww2"} fontSize="medium" style={{
          color: theme ? "white" : "black"
        }} onClick={() => {
        ...
        <hr className={theme ? "seperate" : "seperate-light"} style={isBtnClicked === true ? {
        marginTop: "6px"
      } : {
        marginTop: "15px"
      }} />
