...
function Browse() {
  ...
  return <>
      ...
      <SkeletonTheme baseColor={theme ? "#353535" : "#aaaaaa"} highlightColor={theme ? "#444" : "#b6b6b6"}>
        <div className={theme ? "browse" : "browse light-mode"} style={loading === true ? {
        display: "flex"
      } : {
        display: "none"
      }}>
          <div className={menuClicked === true ? `browse-data ${theme ? "" : "light-mode"}` : `browse-data2 ${theme ? "" : "light-mode"}`} style={menuClicked === false ? {
          left: "74px"
        } : {
          left: "250px"
        }}>
            <div className={theme ? "popular-categories" : "popular-categories light-mode"}>
              ...
              return <div className={TagsSelected === element ? `top-tags ${theme ? "tag-color" : "tag-color-light"}` : `top-tags ${theme ? "" : "tagcolor-newlight"}`} key={index}>
                    <p onClick={() => {
              ...
              <div className="uploaded-videos">
                ...
                length: 16
                    ...
                    <div className="video-data">
                      <Skeleton key={index} count={1} width={330} height={186} style={{
                    borderRadius: "12px"
                  }} className="sk-browse-vid" />
                      <div className="channel-basic-data">
                        <Skeleton key={index} count={1} width={40} height={40} style={{
                      borderRadius: "100%",
                      marginTop: "40px"
                    }} className="sk-browse-profile" />
                        <Skeleton key={index} count={2} width={250} height={15} style={{
                      position: "relative",
                      top: "40px",
                      left: "15px"
      ...
      display: "flex"
        ...
        left: "250px "
          ...
          marginLeft: menuClicked ? "40px" : "40px"
            ...
            <div className="uploaded-videos" style={menuClicked === true ? {
            paddingRight: "50px",
            ...
            display: TagsSelected === "All" ? "grid" : "none"
              ...
              {thumbnails && thumbnails.length > 0 && thumbnails.map((element, index) => {
              return <div className="video-data" key={index} style={Visibility[index] === "Public" ? {
                display: "block"
              } : {
                display: "none"
              }} onClick={() => {
                ...
                navigate(`/video/${VideoID[index]}`);
                  ...
                  width: "330px",
                  borderRadius: "10px"
                }} src={element} alt="thumbnails" className="browse-thumbnails" />
                      ...
                      marginTop: "10px"
                          ...
                          <div className="video-uploader">
                            <Tooltip TransitionComponent={Zoom} title={uploader[index]} placement="top">
                              <p className={theme ? "uploader" : "uploader text-light-mode2"} style={{
                          marginTop: "10px"
                        }}>
                                {uploader[index]}
                              </p>
                          ...
                          <div className={theme ? "view-time" : "view-time text-light-mode2"}>
                            <p className="views">
                              {VideoViews[index] >= 1e9 ? `${(VideoViews[index] / 1e9).toFixed(1)}B` : VideoViews[index] >= 1e6 ? `${(VideoViews[index] / 1e6).toFixed(1)}M` : VideoViews[index] >= 1e3 ? `${(VideoViews[index] / 1e3).toFixed(1)}K` : VideoViews[index]}{" "}
                              views
                            </p>
            ...
            <div className="uploaded-videos2" style={menuClicked === true ? {
            paddingRight: "50px",
            display: TagsSelected !== "All" ? "grid" : "none"
          } : {
            paddingRight: "0px",
            display: TagsSelected !== "All" ? "grid" : "none"
              ...
              {FilteredVideos && FilteredVideos.map((element, index) => {
              return <div className="video-data" key={index} style={element.visibility === "Public" ? {
                display: "block"
              } : {
                display: "none"
              }} onClick={() => {
                ...
                navigate(`/video/${element._id}`);
                  ...
                  width: "330px",
                  borderRadius: "10px"
                }} src={element.thumbnailURL} alt="thumbnails" className="browse-thumbnails" />
                      <p className="duration">
