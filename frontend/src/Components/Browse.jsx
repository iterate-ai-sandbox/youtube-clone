                ...
                thumbnails.map((element, index) => {
                  return (
                    <div
                      ...
                      onClick={() => { if (user?.success) { updateViews(VideoID[index]); setTimeout(() => { navigate(`/video/${VideoID[index]}`); }, 400); } navigate(`/video/${VideoID[index]}`); mixpanel.track('video clicked', { video_publisher: uploader[index], video_title: Titles[index], video_length_in_minutes: Math.floor(Duration[index] / 60) }); }}
                    >
                      <img
                        style={{
                          width: "330px",
