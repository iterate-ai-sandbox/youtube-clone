  ...
  return (
   <>
    ...
    <div className="searched-content">
     ...
     <p className={theme ? 'no-results' : 'no-results text-light-mode'}>No subscriptions found!</p>
    </div>
   </>
  )
 }
       ...
       <div
        ...
        {subscriptions.length > 0 &&
         subscriptions.map((element, index) => {
          return (
           <div className={theme ? 'sub-channels' : 'sub-channels2'} key={index}>
            <Skeleton
             count={1}
             width={100}
             height={100}
            ...
            <div className="channel-basic-data2">
             ...
             <div className={theme ? 'channel-text-data2' : 'channel-text-data2 text-light-mode'}>
              ...
              <div className={theme ? 'view-time23' : 'view-time23 text-light-mode2'}>
               <p className="views2">{element.views >= 1e9 ? `${(element.views / 1e9).toFixed(1)}B` : element.views >= 1e6 ? `${(element.views / 1e6).toFixed(1)}M` : element.views >= 1e3 ? `${(element.views / 1e3).toFixed(1)}K` : element.views} views</p>
               <p
