...
function Subscriptions() {
      ...
      try {
        if (subscriptions && subscriptions.length > 0) {
          ...
          for (const element of subscriptions) {
            const response = await fetch(`${backendURL}/getotherchannel/${element.channelID}`);
            const userEmail = await response.json();
            const response2 = await fetch(`${backendURL}/getuservideos/${userEmail}`);
  ...
  return <>
      ...
      <div className="subscription-content">
        <div className="all-subs-dataaa" style={menuClicked === false ? {
        left: "150px",
        width: "85%"
      } : {
        left: "300px",
        width: "76%"
          ...
          <div className="subscribed-channels">
            ...
            <SkeletonTheme baseColor={theme ? "#353535" : "#aaaaaa"} highlightColor={theme ? "#444" : "#b6b6b6"}>
              <div className="channels-full-list" style={loading === true ? {
              display: "flex"
            } : {
              display: "none"
            }}>
                {subscriptions.length > 0 && subscriptions.map((element, index) => {
                return <div className={theme ? "sub-channels" : "sub-channels2"} key={index}>
                        <Skeleton count={1} width={100} height={100} style={{
                    borderRadius: "100%"
                  }} className="sk-channelDP" />
                        <Skeleton count={1} width={120} height={22} style={{
                    position: "relative",
                    top: "20px"
              ...
              <div className="subscribed-videos sk-subs" style={loading === true ? {
              display: "block",
              position: "relative",
              top: "20px"
            } : {
              display: "none"
                ...
                <div className="subs-videos-all">
                  ...
                  length: 10
                      ...
                      <div className="subs-video-data" style={loading === true ? {
                    display: "block"
                  } : {
                    display: "none"
                  }}>
                        <Skeleton count={1} width={300} height={169} style={{
                      borderRadius: "12px"
                    }} className="sk-channelvid" />
                        <div className="channel-basic-data2">
                          <Skeleton count={1} width={40} height={40} style={{
                        borderRadius: "100%",
                        marginTop: "40px"
                      }} className="sk-thisvid-img" />
                          <Skeleton count={2} width={220} height={15} style={{
                        position: "relative",
                        top: "40px",
                        left: "15px"
            ...
            display: "flex"
              ...
              {subscriptions.length > 0 && subscriptions.map((element, index) => {
              return <div className={theme ? "sub-channels" : "sub-channels2"} key={index} onClick={() => {
          ...
          <div className="subscribed-videos" style={loading === true ? {
          visibility: "hidden",
          display: "none"
        } : {
          visibility: "visible",
          display: "block"
            ...
            <div className="subs-videos-all">
              {subsVideos.length > 0 && subsVideos.map((element, index) => {
              return <>
                      <div className="subs-video-data" key={index} onClick={() => {
                  if (user?.email) {
                  ...
                  display: element.visibility === "Public" ? "block" : "none"
                        ...
                        width: "88%"
                            ...
                            <div className="video-uploader2">
                              <p className={theme ? "uploader2" : "uploader2 text-light-mode2"} style={{
                          marginTop: "10px"
                        }}>
                                {element.uploader}
                              </p>
                            ...
                            <div className={theme ? "view-time23" : "view-time23 text-light-mode2"}>
                              ...
                              <p className="upload-time2" style={{
                          marginLeft: "5px"
                        }}>
                                &#x2022;{" "}
                                {(() => {
