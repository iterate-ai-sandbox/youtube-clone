  ...
  <>
   ...
   <div className={theme ? 'main-left-section main-2' : 'main-left-section main-2 light-mode'} style={menuClicked === false ? {display: 'flex'} : {display: 'none'}}>
    ...
    <div className="second-section">
     ...
     <div
      className={selected === 'watch-later' ? `watch-later watch-later2 sec-data sec-data2 ${theme ? 'changeBG' : 'changeBG-light'}` : 'watch-later watch-later2 sec-data sec-data2'}
      onClick={e => {
       mixpanel.track('watch later menu option selected')
       if (user?.email) {
        localStorage.setItem('selected', 'watch-later')
        navigate('/watchlater')
       } else {
