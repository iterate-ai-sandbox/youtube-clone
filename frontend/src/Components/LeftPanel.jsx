...
function LeftPanel() {
 ...
 return (
  <>
   <div className={theme ? 'main-left-section' : 'main-left-section light-mode'} style={menuClicked === false ? {display: 'none'} : {display: 'block'}}>
    <div className="first-section ">
     ...
     <div className="subscribed-channels" style={Subscriptions && Subscriptions.length > 0 ? {display: 'block'} : {display: 'none'}}>
      {Subscriptions &&
        ...
        return (
         <>
          <SkeletonTheme baseColor={theme ? '#353535' : '#aaaaaa'} highlightColor={theme ? '#444' : '#b6b6b6'}>
           <div className="mysubscriptions" key={index} style={loading === true ? {visibility: 'visible'} : {display: 'none'}}>
            <Skeleton count={1} width={35} height={35} style={{borderRadius: '100%'}} />
            <Skeleton
             count={1}
             width={122}
             height={16}
    ...
    <div className="second-section">
     <div
      className={selected === 'library' ? `library sec-data ${theme ? 'changeBG' : 'changeBG-light'}` : 'library sec-data'}
      onClick={() => {
       if (user?.email) {
     ...
     <div
      className={selected === 'watch-later' ? `watch-later sec-data ${theme ? 'changeBG' : 'changeBG-light'}` : 'watch-later sec-data'}
      onClick={() => {
       if (user?.email) {
     ...
     <div
      className={selected === 'liked-video' ? `liked-video sec-data ${theme ? 'changeBG' : 'changeBG-light'}` : 'liked-video sec-data'}
      onClick={() => {
       if (user?.email) {
   ...
   {/* SHORT HAND  */}
   <div className={theme ? 'main-left-section main-2' : 'main-left-section main-2 light-mode'} style={menuClicked === false ? {display: 'flex'} : {display: 'none'}}>
    <div className="first-section ">
     <div
     ...
     <div
      className={selected === 'subscription' ? `subscription subscription2 sec-data sec-data2 ${theme ? 'changeBG' : 'changeBG-light'}` : 'subscription subscription2 sec-data sec-data2'}
      onClick={() => {
       if (user?.email) {
        localStorage.setItem('selected', 'subscription')
        navigate('/subscriptions')
    ...
    <div className="second-section">
     <div
      className={selected === 'library' ? `library library2 sec-data sec-data2 ${theme ? 'changeBG' : 'changeBG-light'}` : 'library library2 sec-data sec-data2'}
      onClick={() => {
       if (user?.email) {
        localStorage.setItem('selected', 'library')
        navigate('/library')
     ...
     <div className={selected === 'watch-later' ? `watch-later watch-later2 sec-data sec-data2 ${theme ? 'changeBG' : 'changeBG-light'}` : 'watch-later watch-later2 sec-data sec-data2'} onClick={() => { if (user?.email) { localStorage.setItem('selected', 'watch-later'); mixpanel.track('watch later menu option selected'); navigate('/watchlater') } else { setisbtnClicked(true) document.body.classList.add('bg-css') } }} >
      {selected === 'watch-later' ? <WatchLaterIcon fontSize="medium" style={{color: theme ? 'white' : 'black'}} /> : <WatchLaterOutlinedIcon fontSize="medium" style={{color: theme ? 'white' : 'black'}} />}
     </div>
     <div
      className={selected === 'liked-video' ? `liked-video liked-video2 sec-data sec-data2 ${theme ? 'changeBG' : 'changeBG-light'}` : 'liked-video liked-video2 sec-data sec-data2'}
      onClick={() => {
       if (user?.email) {
        localStorage.setItem('selected', 'liked-video')
   ...
   {/* SHORT HAND - 2 */}
   <div className={theme ? 'main-left-section main-2 main-3' : 'main-left-section main-2 main-3 light-mode'} style={{display: 'none'}}>
    <div className="first-section ">
     <div
      className={selected === 'home' ? `home sec-data sec-data2 ${theme ? 'changeBG' : 'changeBG-light'}` : 'home sec-data sec-data2'}
      onClick={() => {
   ...
   <div className={theme ? 'auth-popup' : 'auth-popup light-mode text-light-mode'} style={isbtnClicked === true ? {display: 'block'} : {display: 'none'}}>
    ...
    <div className="signin-last" style={isSwitch === true ? {display: 'block'} : {display: 'none'}}>
     <Signin />
     <div className="already">
   ...
   {/* SECONDARY PANEL  */}
   <div className={closePanel === true ? `secondary-panel moveout ${theme ? '' : 'light-mode'}` : `secondary-panel ${theme ? '' : 'light-mode'}`} style={{display: togglepanel ? 'block' : 'none'}}>
    ...
    <div className={theme ? 'main-left-section-new' : 'main-left-section-new light-mode'}>
     <div className="first-section ">
      <div
       className={selected === 'home' ? `home sec-data ${theme ? 'changeBG' : 'changeBG-light'}` : 'home sec-data'}
       onClick={() => {
        ...
        Subscriptions.map((element, index) => {
         return (
          <>
           <SkeletonTheme baseColor={theme ? '#353535' : '#aaaaaa'} highlightColor={theme ? '#444' : '#b6b6b6'}>
            <div className="mysubscriptions" key={index} style={loading === true ? {visibility: 'visible'} : {display: 'none'}}>
             <Skeleton count={1} width={40} height={40} style={{borderRadius: '100%'}} />
             <Skeleton
              count={1}
              width={122}
              height={20}
     ...
     <div className="second-section">
      ...
      <div className="developer">
       <CodeIcon fontSize="medium" style={{color: theme ? 'white' : 'black'}} />
       <a href="https://github.com/shubho0908" target="_blank" rel="noreferrer">
        Shubhojeet Bera 🚀
       </a>
      </div>
     </div>
   ...
   <div className={theme ? 'horizontal-panel' : 'horizontal-panel light-mode'}>
    <div className="horizontal-main-section">
     <div
      className={theme ? 'home-hori hori' : 'home-hori hori text-light-mode'}
      onClick={() => {
       localStorage.setItem('selected', 'home')
       navigate('/')
      }}
     ...
     <div
      className={theme ? 'trending-hori hori' : 'trending-hori hori text-light-mode'}
      onClick={() => {
       localStorage.setItem('selected', 'trending')
       navigate('/trending')
      }}
