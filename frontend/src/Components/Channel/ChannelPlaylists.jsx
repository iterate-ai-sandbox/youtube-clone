        ...
        return (
         <>
          <div
           ...
           key={index}
           style={
            prop?.newmail !== user?.email && element.playlist_privacy === 'Private'
             ? {
                display: 'none'
               }
             : {
          ...
          >
           <div className="keep-playlist-one">
            <div className="playlist-main-img">
             <img
              src={element.playlist_videos[0] !== undefined ? element.playlist_videos[0].thumbnail : deleteIMG}
              alt=""
            ...
            <div
             className={theme ? 'playlist-element' : 'playlist-element text-dark-mode'}
             style={{
              backgroundColor
             }}
             onClick={() => {
