  ...
  return (
   <>
    <div className="featured-channels-sections">
     <div
      className={theme ? 'featured-channel-btn' : 'featured-channel-btn btn-light-mode'}
      style={
    ...
    >
     ...
     <p className={theme ? 'no-results no-channel' : 'no-results no-channel text-light-mode'}>No channels found!</p>
    </div>
   </>
  )
     ...
     >
      {featuredChannelsData &&
       ...
       featuredChannelsData.map(index => {
        return (
         <div className={user?.email === prop?.newmail ? `featured-channelss featured-channelss-new ${theme ? '' : 'feature-light'}` : `featured-channelss ${theme ? '' : 'feature-light2'}`} key={index}>
          <Skeleton
           count={1}
           width={100}
           height={100}
    ...
    >
     {featuredChannelsData &&
      ...
      featuredChannelsData.map((element, index) => {
       return (
        <div
         className={user?.email === prop?.newmail ? `featured-channelss featured-channelss-new ${theme ? '' : 'feature-light'}` : `featured-channelss ${theme ? '' : 'feature-light2'}`}
         key={index}
         onClick={() => {
        ...
        >
         ...
         <p
          className={theme ? 'feature-channel-name' : 'feature-channel-name text-light-mode'}
          style={{
           marginTop: '6px'
          }}
         >
 ...
 return (
  <>
   <div className="featured-channels-sections">
    ...
    <div
     className={theme ? 'add-feature-channel' : 'add-feature-channel text-light-mode'}
     style={{
     ...
     <div className="my-subscribed-channels">
      {Subscriptions && Subscriptions.length > 0 ? (
       Subscriptions.map((element, index) => {
        return (
         <div
          className={SelectedChannel === element.channelname ? `subscribed-channels-all ${theme ? 'locked' : 'locked2'} ${theme ? '' : 'feature-light2'}` : `subscribed-channels-all ${theme ? '' : 'feature-light2'}`}
          key={index}
          onClick={() => {
