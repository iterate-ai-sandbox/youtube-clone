       ...
       <div className="channel-topleft-data">
        <div className="channel-left">
         ...
         <div className={theme ? 'channel-extra' : 'channel-extra text-light-mode2'}>
          ...
          {myVideos && myVideos.message !== "USER DOESN'T EXIST" ? <p className="my-videoscount">{myVideos && myVideos.length} videos</p> : <p className="my-videoscount">0 videos</p>}
         </div>
         <div
          className={theme ? 'more-about' : 'more-about text-light-mode2'}
          onClick={() => {
     ...
     <div className="channel-mid-content">
      <div className="different-sections">
       ...
       {Section === 'Videos' ? (
        ...
        <p
         className={theme ? 'channel-videos' : 'channel-videos text-light-mode2'}
         style={
          myVideos && myVideos.message === "USER DOESN'T EXIST"
           ? {
              display: 'none'
       ...
       {Section === 'Playlists' ? (
        <p
         className={theme ? 'channel-playlists1' : 'channel-playlists2'}
         onClick={() => {
        ...
        <p
         className={theme ? 'channel-playlists' : 'channel-playlists text-light-mode2'}
         onClick={() => {
          localStorage.setItem('Section', 'Playlists')
          reloadPage()
         }}>
       ...
       {Section === 'Subscriptions' ? (
        <p
         className={theme ? 'channel-subscriptions1' : 'channel-subscriptions2'}
         onClick={() => {
        ...
        <p
         className={theme ? 'channel-subscriptions' : 'channel-subscriptions text-light-mode2'}
         onClick={() => {
          localStorage.setItem('Section', 'Subscriptions')
          reloadPage()
         }}>
       ...
       {Section === 'About' ? (
        ...
        <p
         className={theme ? 'channel-about' : 'channel-about text-light-mode2'}
         onClick={() => {
          localStorage.setItem('Section', 'About')
          reloadPage()
         }}>
