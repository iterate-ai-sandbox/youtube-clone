    ...
    <>
      <div className={theme === true ? "navbar" : "navbar light-mode"}>
        ...
        >
          ...
          <button onClick={(e) => { mixpanel.track('signin_clicked', { 'list_of_video_titles': 'NONE' }); if (isbtnClicked === false) { setisbtnClicked(true); document.body.classList.add("bg-css"); } else { setisbtnClicked(false); document.body.classList.remove("bg-css"); } }} className={theme ? "signin" : "signin signin-light"} style={ User.success ? { display: "none", } : { display: "flex", } } >
