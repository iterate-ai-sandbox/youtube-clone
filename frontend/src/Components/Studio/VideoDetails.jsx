  ...
  <>
   ...
   >
    <div className="current-editvideodata">
     <p className={theme ? 'current-tophead' : 'current-tophead text-light-mode'}>Video details</p>
     <div className="thissection-btns">
      ...
      <button
       className={changes === false ? 'disabled-btn2' : 'video-editbtnss'}
       onClick={() => {
    ...
    <div className="current-editvideo-data">
      ...
      <div className="current-video-editable-section">
       <div className="currentvideo-title">
        <input
         type="text"
         name="video-title"
         className={theme ? 'currentvideo-title-inp' : 'currentvideo-title-inp text-light-mode new-light-border'}
         value={previewTitle}
         required
         onChange={e => {
       ...
       <div className="currentvideo-desc">
        <textarea
         ...
         name="video-desc"
         required
         className={theme ? 'currentvideo-desc-inp' : 'currentvideo-desc-inp new-light-border text-light-mode'}
         onChange={e => {
         ...
         maxLength={5000}
        />
        <p className={theme ? 'desc-sample-txt' : 'desc-sample-txt desc-light-mode'}>Description</p>
       </div>
       <div className="currentvideo-thumbnailedit">
        <p className={theme ? '' : 'text-light-mode'}>Thumbnail</p>
        <p className={theme ? '' : 'text-light-mode2'}>Select or upload a picture that shows what&apos;s in your video. A good thumbnail stands out and draws viewers&apos; attention.</p>
        <div className="mythumbnails-sectionn">
         {thumbnailImage ? (
          ...
          <label htmlFor="thumbnail-upload" className={theme ? 'uploadnew-thumbnaill' : 'uploadnew-thumbnaill new-light-border2'}>
        ...
        >
         ...
         <p className={theme ? '' : 'text-light-mode2'}>Tags can be useful if content in your video is commonly misspelled. Otherwise, tags play a minimal role in helping viewers find your video.</p>
         <input
          type="text"
          name="video-title"
          className={theme ? 'currentvid-tagsinp' : 'currentvid-tagsinp new-light-border text-light-mode'}
          value={previewTags}
          required
          onChange={e => {
     ...
     <div className="video-details-right">
       ...
       <div className={theme ? 'preview-data-details' : 'preview-data-details preview-light2 text-light-mode'}>
        <div className="preview-part1">
         <div className="video-linkleft">
          <p className={theme ? '' : 'text-light-mode2'}>Video link</p>
          <p
        ...
        <div className="preview-part2">
         ...
         <p>{videodata && videodata.Title.length <= 35 ? videodata && videodata.Title : `${videodata && videodata.Title.slice(0, 35)}...`}</p>
        </div>
        <div className="preview-part3">
         <p className={theme ? '' : 'text-light-mode2'}>Video quality</p>
         <HdIcon
          fontSize="large"
          style={{
           color: '#3ea6ff',
      ...
      <div
       className={theme ? 'video-visibility-section' : 'video-visibility-section new-light-border'}
       onClick={() => {
      ...
      >
       ...
       <div className="visibility-current-data">
        <div className="privacy-current">
         {updatePrivacy === 'Public' || (updatePrivacy === null && videodata && videodata.visibility === 'Public') ? (
         ...
         {updatePrivacy === null ? <p className={theme ? '' : 'text-light-mode'}>{videodata && videodata.visibility}</p> : <p className={theme ? '' : 'text-light-mode'}>{updatePrivacy}</p>}
        </div>
      ...
      <div
       className={theme ? 'select-any-visibility' : 'select-any-visibility light-mode'}
       style={
        privacyClicked === true
         ? {
            display: 'block'
      ...
      >
       <div
        className={theme ? 'thispublic-visibility' : 'thispublic-visibility preview-lightt'}
        onClick={() => {
         setprivacy('Public')
       ...
       <div
        className={theme ? 'thisprivate-visibility' : 'thisprivate-visibility preview-lightt'}
        onClick={() => {
         setprivacy('Private')
         setprivacyClicked(false)
         setChanges(true)
