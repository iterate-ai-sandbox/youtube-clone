...
function Content() {
 ...
 return (
  <>
          ...
          <tr
           ...
           <td className="video-cell">
            ...
            <div
             ...
             />
             <p className="video-left-duration">{Math.floor(element.videoLength / 60) + ':' + (Math.round(element.videoLength % 60) < 10 ? '0' + Math.round(element.videoLength % 60) : Math.round(element.videoLength % 60))}</p>
            </div>
           ...
           <td>
            <p className={theme ? '' : 'text-light-mode2'}>{element.views && element.views.toLocaleString()}</p>
           </td>
           <td>
            <p className={theme ? '' : 'text-light-mode2'}>{element.comments && element.comments.length}</p>
           </td>
           <td>
   ...
   <div
    className={theme ? 'last-delete-warning' : 'last-delete-warning light-mode text-light-mode'}
    style={
    ...
    <div className="deleted-video-data">
     <div className={theme ? 'thisdelete-data' : 'thisdelete-data social-lightt'}>
      ...
      <p className="thisdelete-duration">{Math.floor(DeleteVideoData && DeleteVideoData.videoLength / 60) + ':' + (Math.round(DeleteVideoData && DeleteVideoData.videoLength % 60) < 10 ? '0' + Math.round(DeleteVideoData && DeleteVideoData.videoLength % 60) : Math.round(DeleteVideoData && DeleteVideoData.videoLength % 60))}</p>
      <div className="thisdelete-video-details">
       <p className="delete-title">{DeleteVideoData && DeleteVideoData.Title.length <= 15 ? DeleteVideoData.Title : `${DeleteVideoData && DeleteVideoData.Title.slice(0, 15)}...`}</p>
       ...
       <p className={theme ? 'delete-views' : 'delete-views text-light-mode2'}>{DeleteVideoData && DeleteVideoData.views + ' views'}</p>
      </div>
     </div>
    </div>
    <div className="delete-consent">
     ...
     />
     <p>I understand that deleting a video from YouTube is permanent and cannot be undone.</p>
    </div>
    <div className="delete-video-buttons">
     <button
      className={theme ? 'download-delete-video delete-css' : 'download-delete-video delete-css blue-txt'}
      onClick={() => {
       if (DeleteVideoData) {
     ...
     <div className="extra-two-delete-btns">
      <button
       className={theme ? 'cancel-delete delete-css' : 'cancel-delete delete-css blue-txt'}
       onClick={() => {
      ...
      <button
       className={theme ? 'delete-video-btn delete-css' : `delete-video-btn delete-css ${!boxclicked ? '' : 'blue-txt'}`}
       disabled={!boxclicked}
       onClick={() => {
