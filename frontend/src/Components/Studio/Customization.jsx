   ...
   <div className="channel-customize">
    ...
    >
     <div className="customize-header">
      <p className={theme ? '' : 'text-light-mode'}>Channel customization</p>
     </div>
     <div className="redirectss">
      <div className="left-redirects">
       ...
       <p
        className={currentTab === 'basic' ? `basic-txt1 ${theme ? '' : 'text-light-mode2'}` : `basic-txt ${theme ? '' : 'text-light-mode2'}`}
        style={{
         marginLeft: '40px'
        }}
     ...
     <hr className="breakk" />
     <div className="customize-data-section">{currentTab === 'branding' ? <Branding /> : <Basic />}</div>
    </div>
   </div>
  </>
 )
