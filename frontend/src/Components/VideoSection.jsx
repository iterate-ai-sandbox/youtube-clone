{"reformatted_code_snippet": "import mixpanel from 'mixpanel-browser';\nimport AddToPhotosOutlinedIcon from '@mui/icons-material/AddToPhotosOutlined';"}
...
function VideoSection() {
 ...
 // USE EFFECTS
 {"reformatted_code_snippet": "useEffect(() => { mixpanel.track('video_page_opened', { video_name: Title }); }, [])"}
 ...
 {"reformatted_code_snippet": "const likeVideo = async () => {\n    if (message === 'Liked') {\n        mixpanel.track('video_liked');\n    }\n}"}
  try {
   setLikeLoading(true)
