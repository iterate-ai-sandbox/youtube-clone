        ...
        <div className="left-video-section2">
          ...
          <div className="some-channel-data">
            ...
            <div className="channel-right-data c-right1">
              ...
              <div className={ theme ? "share" : "share share-light text-light-mode" } onClick={() => { mixpanel.track('share_clicked', { number_of_views: views }); if (shareClicked === false) { setShareClicked(true); document.body.classList.add("bg-css"); } else { setShareClicked(false); document.body.classList.remove("bg-css"); } }} >
                <ReplyIcon
                  fontSize="medium"
                  style={{
                    color: theme ? "white" : "black",
