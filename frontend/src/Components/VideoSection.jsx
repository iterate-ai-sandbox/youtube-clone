...
function VideoSection() {
 ...
 <div className="share" onClick={() => { setShareClicked(!shareClicked); mixpanel.track('video share initiated', { 'video title': Title }); }}>
 ...
 // USE EFFECTS
 useEffect(() => { mixpanel.track('video page opened', { 'video title': Title, 'video length': videoLength }); }, [])
