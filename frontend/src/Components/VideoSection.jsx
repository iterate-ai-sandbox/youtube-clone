      ...
      <div className="channel-right-data c-right1">
       ...
       >
        <div
         ...
         onClick={() => {
          if (user?.email) {
           likeVideo(); mixpanel.track('video_liked'); } else { setisbtnClicked(true) document.body.classList.add('bg-css') } }} >
        ...
        <div
         ...
         onClick={() => {
          if (user?.email) {
           DislikeVideo(); mixpanel.track('video_liked'); } else { setisbtnClicked(true) document.body.classList.add('bg-css') } }} >
