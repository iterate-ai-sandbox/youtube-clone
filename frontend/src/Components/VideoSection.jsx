      ...
      >
        <div className="left-video-section2">
          ...
          <div className="some-channel-data">
            ...
            >
              <img src={ChannelProfile} alt="channelDP" className="channelDP" loading="lazy" onClick={() => { mixpanel.track('channel_picture_clicked'); if (channelID !== undefined) { navigate(`/channel/${channelID}`); } }} />
