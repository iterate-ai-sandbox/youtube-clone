...
function VideoSection() {
  ...
  useEffect(() => {
    if (videoData && videoData.VideoData) {
      mixpanel.track('video_page_opened', { 'video_title': Title, 'number_of_likes': VideoLikes });
    }
  }, [videoData, Title, VideoLikes]);
              ...
              <div
                ...
                onClick={() => {
                  if (shareClicked === false) {
                    ...
                    setShareClicked(false);
<div className="share" onClick={() => { mixpanel.track('share_video_clicked'); if (shareClicked === false) { setShareClicked(true); document.body.classList.add("bg-css"); } else { setShareClicked(false); document.body.classList.remove("bg-css"); } }}>
                  }
                }}
              >
                <ReplyIcon
