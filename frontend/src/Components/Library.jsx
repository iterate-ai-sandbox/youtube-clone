...
function Library() {
 ...
 }, [savedPlaylist, PlaylistData, user?.email])
 useEffect(() => {
  ...
  return (
   <>
    ...
    <div className="searched-content">
     ...
     <p className={theme ? 'no-results' : 'no-results text-light-mode'}>No data found!</p>
    </div>
   </>
  )
 }
        ...
        return (
         ...
         >
          ...
          <div className="thislibrary-video-details">
           <p>{element.Title && element.Title.length <= 46 ? element.Title : `${element.Title.slice(0, 46)}..`}</p>
           <div className="thisvideo-extra-daataa">
            <div className={theme ? 'thisvide-oneliner-1' : 'thisvide-oneliner-1 text-light-mode2'}>
     ...
     >
      ...
      <div className="thischannel-playlists2">
       {PlaylistArray &&
        ...
        PlaylistArray.slice(0, Math.min(6 - savedPlaylist.length, 6)).map((element, index) => {
         return (
          <div className="created-all-playlistss2" key={index}>
           ...
           <div
            className={theme ? 'playlistt-details playlists-details2' : 'playlistt-details playlists-details2 text-light-mode'}
            style={{
             position: 'relative',
             top: '12px'
            }}
       ...
       {savedPlaylist &&
        ...
        savedPlaylist.slice(0, Math.min(6 - PlaylistArray.length, 6)).map((element, index) => {
         return (
          <div className="created-all-playlistss2" key={index}>
           <Skeleton
            count={1}
         ...
         <div className="created-all-playlistss2" key={index}>
          ...
          <div className={theme ? 'playlistt-details playlists-details2' : 'playlistt-details playlists-details2 text-light-mode'}>
           ...
           <div className="extra-playlists-data">
            ...
            <div
             className={theme ? 'private-privacyy' : 'private-privacyy-light'}
             style={
